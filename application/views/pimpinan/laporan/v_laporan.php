		...
		<div class="min-height-200px">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Laporan Return Barang Perharian</h3>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
							<?php
							echo form_open('laporan/lap_hari_return') ?>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										<label>Tanggal</label>
				...
				<div class="col-md-4">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Laporan Return Barang Perbulan</h3>
						</div>
						<div class="card-body">
							<?php
							echo form_open('laporan/lap_bulan_return') ?>
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label>Bulan</label>
				...
				<div class="col-md-4">
					<div class="card card-primary">
						<div class="card-header">
							<h3 class="card-title">Laporan Return Barang Pertahun</h3>
						</div>
						<!-- /.card-header -->
						<div class="card-body">
							<?php
							echo form_open('laporan/lap_tahun_return') ?>
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										<label>Tahun</label>
