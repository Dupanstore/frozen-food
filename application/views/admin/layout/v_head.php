...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>GRIYA FROZEN FOOD</title>

	<!-- Site favicon -->
	<link rel="rajawali1" sizes="180x180" href="<?= base_url() ?>deskapp-master/vendors/images/frozen-food.png">
	<link rel="icon" type="image/png" sizes="32x32" href="<?= base_url() ?>deskapp-master/vendors/images/frozen-food.png">
	<link rel="icon" type="image/png" sizes="16x16" href="<?= base_url() ?>deskapp-master/vendors/images/frozen-food.png">
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url() ?>deskapp-master/src/plugins/jvectormap/jquery-jvectormap-2.0.3.css">
